{
  ...
  container: {
    ...
    navidrome: {
      ...
      tag: '0.64.1@sha256:df22d661b8d0322c33754d999b567150df9e131a47ae53be71fed0154bf8cef5',
    },
    mumble: {
    ...
    hass: {
      ...
      tag: '2026.9.3@sha256:d8922685169707fd91e8b9729902d975f06157d005e422874d201e0261dda196',
    },
    grocy: {
    ...
    esphome: {
      ...
      tag: '2026.9.0@sha256:f6509fcf917a732fd80058567b237d5b9286b9dc6c8dde1b655fbb69ebd600ad',
    },
    chhoto: {
      image: 'sintan1729/chhoto-url',
      tag: '7.8.1@sha256:edfce59bb764ff03f2db4d68ca787b42d18ed53727acd41b69ccbbe141e3fc3f',
    },
    nodered: {
    ...
    valkey: {
      image: 'valkey/valkey',
      tag: '8.1.10-alpine@sha256:081c2f5cb575efc901aa80ff9cdbd1ec6a301682fd35e1ebb4b0990a4a4a8507',
    },
    telegraf: {
      image: 'telegraf',
      tag: '1.40.1-alpine@sha256:6606553b5019151de171984e9ce938eac859d6987aa5329c420597737bf1a9a0',
    },
    influxdb: {
      image: 'influxdb',
    ...
    anubis: {
      ...
      tag: 'v1.28.0-pre2@sha256:a407747e4edebc91dbd4ec3341e724c44aee5f5ed25935c085a5d287b642328b',
    },
    cnpg_vectorchord: {
