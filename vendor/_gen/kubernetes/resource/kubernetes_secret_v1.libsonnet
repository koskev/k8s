{
  ...
  functions(terraformName):: {
    ...
    withBinaryDataWoRevision(value):: self { resource+: {
    ...
    withDataWo(value):: self { resource+: {
      kubernetes_secret_v1+: { [terraformName]+: { data_wo: value } },
    } },
    '#withDataWoRevision':: { 'function': {
      help:
        |||
    ...
    '#withWaitForServiceAccountToken':: { 'function': {
      help:
        |||
          Terraform will wait for the service account token to be created.
        |||,
    } },
    withWaitForServiceAccountToken(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#binary_data_wo_revision':: { 'function': {
        help:
          |||
            The current revision of the write-only "binary_data_wo" attribute. Incrementing this integer value will cause Terraform to update the write-only value.
          |||,
      ...
      '#wait_for_service_account_token':: { 'function': {
        help:
          |||
            Terraform will wait for the service account token to be created.
          |||,
