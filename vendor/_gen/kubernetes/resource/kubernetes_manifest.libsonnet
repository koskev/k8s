{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      kubernetes_manifest+: { [terraformName]+: { [name]: value } },
    } },
    '#withComputedFields':: { 'function': {
      help:
        |||
    ...
    withComputedFields(value):: self { resource+: {
    ...
    withManifest(value):: self { resource+: {
    ...
    withObject(value):: self { resource+: {
      kubernetes_manifest+: { [terraformName]+: { object: value } },
    } },
    '#withWaitFor':: { 'function': {
      help:
        |||
    ...
    withWaitFor(value):: self { resource+: {
