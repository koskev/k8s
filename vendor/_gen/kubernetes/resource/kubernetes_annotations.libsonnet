{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      kubernetes_annotations+: { [terraformName]+: { [name]: value } },
    } },
    '#withAnnotations':: { 'function': {
      help:
        |||
          A map of annotations to apply to the resource.
        |||,
    } },
    withAnnotations(value):: self { resource+: {
    ...
    withApiVersion(value):: self { resource+: {
      kubernetes_annotations+: { [terraformName]+: { api_version: value } },
    } },
    '#withFieldManager':: { 'function': {
      help:
        |||
          Set the name of the field manager for the specified labels.
        |||,
    } },
    withFieldManager(value):: self { resource+: {
    ...
    withKind(value):: self { resource+: {
      kubernetes_annotations+: { [terraformName]+: { kind: value } },
    } },
    '#withTemplateAnnotations':: { 'function': {
      help:
        |||
          A map of annotations to apply to the resource template.
        |||,
    } },
    withTemplateAnnotations(value):: self { resource+: {
