{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { ephemeral+: {
      kubernetes_certificate_signing_request_v1+: { [terraformName]+: { [name]: value } },
    } },
    '#withAutoApprove':: { 'function': {
      help:
        |||
          Automatically approve the Certificate Signing Request
        |||,
    } },
    withAutoApprove(value):: self { ephemeral+: {
    ...
    withCertificate(value):: self { ephemeral+: {
