{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { data+: {
      kubernetes_resources+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withApiVersion(value):: self { data+: {
      kubernetes_resources+: { [terraformName]+: { api_version: value } },
    } },
    '#withFieldSelector':: { 'function': {
      help:
        |||
          A selector to restrict the list of returned objects by their fields.
        |||,
    } },
    withFieldSelector(value):: self { data+: {
    ...
    withKind(value):: self { data+: {
      kubernetes_resources+: { [terraformName]+: { kind: value } },
    } },
    '#withLabelSelector':: { 'function': {
      help:
        |||
          A selector to restrict the list of returned objects by their labels.
        |||,
    } },
    withLabelSelector(value):: self { data+: {
