{
  ...
  functions(terraformName):: {
    withForEach(value):: self { data+: {
      vault_raft_autopilot_state+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { data+: {
      vault_raft_autopilot_state+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { data+: {
      vault_raft_autopilot_state+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { data+: {
      vault_raft_autopilot_state+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { data+: {
      vault_raft_autopilot_state+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { data+: {
      vault_raft_autopilot_state+: { [terraformName]+: { providers: value } },
    } },
    addCustomData(name, value):: self { data+: {
      vault_raft_autopilot_state+: { [terraformName]+: { [name]: value } },
    } },
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#optimistic_failure_tolerance':: { 'function': {
        help:
          |||
      ...
      '#redundancy_zones_json':: { 'function': {
        help:
          |||
