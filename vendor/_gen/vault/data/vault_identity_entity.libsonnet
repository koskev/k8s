{
  ...
  functions(terraformName):: {
    ...
    '#withAliasId':: { 'function': {
      help:
        |||
          ID of the alias.
        |||,
    } },
    withAliasId(value):: self { data+: {
      vault_identity_entity+: { [terraformName]+: { alias_id: value } },
    } },
    '#withAliasMountAccessor':: { 'function': {
      help:
        |||
          Accessor of the mount to which the alias belongs to. This should be supplied in conjunction with `alias_name`.
        |||,
    } },
    withAliasMountAccessor(value):: self { data+: {
      vault_identity_entity+: { [terraformName]+: { alias_mount_accessor: value } },
    } },
    '#withAliasName':: { 'function': {
      help:
        |||
          Name of the alias. This should be supplied in conjunction with `alias_mount_accessor`.
        |||,
    } },
    withAliasName(value):: self { data+: {
    ...
    withEntityId(value):: self { data+: {
      vault_identity_entity+: { [terraformName]+: { entity_id: value } },
    } },
    '#withEntityName':: { 'function': {
      help:
        |||
          Name of the entity.
        |||,
    } },
    withEntityName(value):: self { data+: {
