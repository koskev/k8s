{
  ...
  functions(terraformName):: {
    ...
    withEnvironment(value):: self { data+: {
    ...
    withMaxCredValidationSeconds(value):: self { data+: {
    ...
    withNumSecondsBetweenTests(value):: self { data+: {
    ...
    withNumSequentialSuccesses(value):: self { data+: {
    ...
    withSubscriptionId(value):: self { data+: {
    ...
    withValidateCreds(value):: self { data+: {
