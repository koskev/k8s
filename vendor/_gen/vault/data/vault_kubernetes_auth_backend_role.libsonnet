{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { data+: {
      vault_kubernetes_auth_backend_role+: { [terraformName]+: { [name]: value } },
    } },
    ...
    '#withAudience':: { 'function': {
      help:
        |||
          Optional Audience claim to verify in the JWT.
        |||,
    } },
    withAudience(value):: self { data+: {
  ...
  ref(terraformName):: {
    local refSelf = self,
    plain(suffix=''):: '${ data.vault_kubernetes_auth_backend_role.%s%s }' % [terraformName, suffix],
    fields:: {
      ...
      '#bound_service_account_names':: { 'function': {
        help:
          |||
      ...
      '#bound_service_account_namespace_selector':: { 'function': {
        help:
          |||
      ...
      '#bound_service_account_namespaces':: { 'function': {
        help:
          |||
