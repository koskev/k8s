{
  ...
  functions(terraformName):: {
    withForEach(value):: self { data+: {
      vault_transform_encode+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { data+: {
      vault_transform_encode+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { data+: {
      vault_transform_encode+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { data+: {
      vault_transform_encode+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { data+: {
      vault_transform_encode+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { data+: {
      vault_transform_encode+: { [terraformName]+: { providers: value } },
    } },
    addCustomData(name, value):: self { data+: {
      vault_transform_encode+: { [terraformName]+: { [name]: value } },
    } },
    ...
    '#withEncodedValue':: { 'function': {
      help:
        |||
          The result of encoding a value.
        |||,
    } },
    withEncodedValue(value):: self { data+: {
    ...
    withTransformation(value):: self { data+: {
