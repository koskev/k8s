{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { data+: {
      vault_gcp_auth_backend_role+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withAliasMetadata(value):: self { data+: {
    ...
    withTokenBoundCidrs(value):: self { data+: {
    ...
    withTokenExplicitMaxTtl(value):: self { data+: {
    ...
    withTokenMaxTtl(value):: self { data+: {
    ...
    withTokenNoDefaultPolicy(value):: self { data+: {
    ...
    withTokenNumUses(value):: self { data+: {
    ...
    withTokenPeriod(value):: self { data+: {
    ...
    withTokenPolicies(value):: self { data+: {
