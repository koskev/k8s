{
  ...
  functions(terraformName):: {
    withForEach(value):: self { data+: {
      vault_identity_oidc_openid_config+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { data+: {
      vault_identity_oidc_openid_config+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { data+: {
      vault_identity_oidc_openid_config+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { data+: {
      vault_identity_oidc_openid_config+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { data+: {
      vault_identity_oidc_openid_config+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { data+: {
      vault_identity_oidc_openid_config+: { [terraformName]+: { providers: value } },
    } },
  ...
  ref(terraformName):: {
    ...
    fields:: {
      '#authorization_endpoint':: { 'function': {
        help:
          |||
      ...
      '#grant_types_supported':: { 'function': {
        help:
          |||
      ...
      '#id_token_signing_alg_values_supported':: { 'function': {
        help:
          |||
      ...
      '#request_uri_parameter_supported':: { 'function': {
        help:
          |||
      ...
      '#response_types_supported':: { 'function': {
        help:
          |||
      ...
      '#subject_types_supported':: { 'function': {
        help:
          |||
      ...
      '#token_endpoint_auth_methods_supported':: { 'function': {
        help:
          |||
