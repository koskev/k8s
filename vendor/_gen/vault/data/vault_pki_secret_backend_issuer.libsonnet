{
  ...
  functions(terraformName):: {
    ...
    withDisableCriticalExtensionChecks(value):: self { data+: {
    ...
    withDisableNameChecks(value):: self { data+: {
    ...
    withDisableNameConstraintChecks(value):: self { data+: {
    ...
    withDisablePathLengthChecks(value):: self { data+: {
