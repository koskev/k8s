{
  ...
  functions(terraformName):: {
    ...
    withDisableIssValidation(value):: self { data+: {
    ...
    withDisableLocalCaJwt(value):: self { data+: {
    ...
    withKubernetesCaCert(value):: self { data+: {
    ...
    withKubernetesHost(value):: self { data+: {
    ...
    withUseAnnotationsAsAliasMetadata(value):: self { data+: {
