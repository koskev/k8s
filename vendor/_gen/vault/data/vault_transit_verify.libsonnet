{
  ...
  functions(terraformName):: {
    withForEach(value):: self { data+: {
      vault_transit_verify+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { data+: {
      vault_transit_verify+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { data+: {
      vault_transit_verify+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { data+: {
      vault_transit_verify+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { data+: {
      vault_transit_verify+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { data+: {
      vault_transit_verify+: { [terraformName]+: { providers: value } },
    } },
    addCustomData(name, value):: self { data+: {
      vault_transit_verify+: { [terraformName]+: { [name]: value } },
    } },
    '#withBatchInput':: { 'function': {
      help:
        |||
    ...
    withBatchInput(value):: self { data+: {
      vault_transit_verify+: { [terraformName]+: { batch_input: value } },
    } },
    '#withBatchResults':: { 'function': {
      help:
        |||
          The results returned from Vault if using batch_input
        |||,
    } },
    withBatchResults(value):: self { data+: {
    ...
    withContext(value):: self { data+: {
      vault_transit_verify+: { [terraformName]+: { context: value } },
    } },
    '#withHashAlgorithm':: { 'function': {
      help:
        |||
          Specifies the hash algorithm to use.
        |||,
    } },
    withHashAlgorithm(value):: self { data+: {
