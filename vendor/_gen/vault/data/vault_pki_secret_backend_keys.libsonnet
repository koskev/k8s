{
  ...
  functions(terraformName):: {
    withForEach(value):: self { data+: {
      vault_pki_secret_backend_keys+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { data+: {
      vault_pki_secret_backend_keys+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { data+: {
      vault_pki_secret_backend_keys+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { data+: {
      vault_pki_secret_backend_keys+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { data+: {
      vault_pki_secret_backend_keys+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { data+: {
      vault_pki_secret_backend_keys+: { [terraformName]+: { providers: value } },
    } },
    addCustomData(name, value):: self { data+: {
      vault_pki_secret_backend_keys+: { [terraformName]+: { [name]: value } },
    } },
