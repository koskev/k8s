{
  ...
  new(terraformName, mount, password, username):: self.functions(terraformName) + {
    ...
    ephemeral+: {
      vault_radius_auth_login+: { [terraformName]+: {
        mount: mount,
        password: password,
        username: username,
      } },
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { ephemeral+: {
      vault_radius_auth_login+: { [terraformName]+: { [name]: value } },
    } },
    '#withMount':: { 'function': {
      help:
        |||
    ...
    withPassword(value):: self { ephemeral+: {
    ...
    withUsername(value):: self { ephemeral+: {
