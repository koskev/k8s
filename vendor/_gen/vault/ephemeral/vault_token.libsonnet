{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { ephemeral+: {
      vault_token+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withMetadata(value):: self { ephemeral+: {
    ...
    withNoDefaultPolicy(value):: self { ephemeral+: {
      vault_token+: { [terraformName]+: { no_default_policy: value } },
    } },
    '#withNoParent':: { 'function': {
      help:
        |||
          Flag to create a token without parent.
        |||,
    } },
    withNoParent(value):: self { ephemeral+: {
      vault_token+: { [terraformName]+: { no_parent: value } },
    } },
    '#withNumUses':: { 'function': {
      help:
        |||
          The number of allowed uses of the token.
        |||,
    } },
    withNumUses(value):: self { ephemeral+: {
    ...
    withPeriod(value):: self { ephemeral+: {
    ...
    withPolicies(value):: self { ephemeral+: {
      vault_token+: { [terraformName]+: { policies: value } },
    } },
    '#withRenewable':: { 'function': {
      help:
        |||
          Flag to allow the token to be renewed.
        |||,
    } },
    withRenewable(value):: self { ephemeral+: {
    ...
    withRoleName(value):: self { ephemeral+: {
    ...
    withType(value):: self { ephemeral+: {
      vault_token+: { [terraformName]+: { type: value } },
    } },
    '#withWrappingTtl':: { 'function': {
      help:
        |||
          The TTL period of the wrapped token.
        |||,
    } },
    withWrappingTtl(value):: self { ephemeral+: {
