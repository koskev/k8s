{
  ...
  new(terraformName, mount):: self.functions(terraformName) + {
    ...
    ephemeral+: {
      vault_gcp_service_account_key+: { [terraformName]+: {
        mount: mount,
      } },
    },
  }
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { ephemeral+: {
      vault_gcp_service_account_key+: { [terraformName]+: { [name]: value } },
    } },
    '#withKeyAlgorithm':: { 'function': {
      help:
        |||
    ...
    withKeyAlgorithm(value):: self { ephemeral+: {
    ...
    withKeyType(value):: self { ephemeral+: {
    ...
    withRoleset(value):: self { ephemeral+: {
    ...
    withStaticAccount(value):: self { ephemeral+: {
