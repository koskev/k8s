{
  ...
  functions(terraformName):: {
    ...
    withDataJson(value):: self { ephemeral+: {
    ...
    withPath(value):: self { ephemeral+: {
      vault_generic_endpoint+: { [terraformName]+: { path: value } },
    } },
    '#withPathWrapTtl':: { 'function': {
      help:
        |||
          The TTL for the wrapped response.
        |||,
    } },
    withPathWrapTtl(value):: self { ephemeral+: {
    ...
    withWriteFields(value):: self { ephemeral+: {
