{
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#revocation_statements':: { 'function': {
        help:
          |||
            Database statements to execute to revoke a user.
          |||,
