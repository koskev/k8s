{
  ...
  functions(terraformName):: {
    ...
    '#withServiceIdentities':: { 'function': {
      help:
        |||
    ...
    withServiceIdentities(value):: self { resource+: {
