{
  ...
  functions(terraformName):: {
    withForEach(value):: self { resource+: {
      vault_mongodbatlas_secret_role+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { resource+: {
      vault_mongodbatlas_secret_role+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { resource+: {
      vault_mongodbatlas_secret_role+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { resource+: {
      vault_mongodbatlas_secret_role+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { resource+: {
      vault_mongodbatlas_secret_role+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { resource+: {
      vault_mongodbatlas_secret_role+: { [terraformName]+: { providers: value } },
    } },
    addCustomData(name, value):: self { resource+: {
      vault_mongodbatlas_secret_role+: { [terraformName]+: { [name]: value } },
    } },
    '#withCidrBlocks':: { 'function': {
      help:
        |||
          Whitelist entry in CIDR notation to be added for the API key
        |||,
    } },
    withCidrBlocks(value):: self { resource+: {
      vault_mongodbatlas_secret_role+: { [terraformName]+: { cidr_blocks: value } },
    } },
    withId(value):: self { resource+: {
      vault_mongodbatlas_secret_role+: { [terraformName]+: { id: value } },
    } },
    '#withIpAddresses':: { 'function': {
      help:
        |||
          IP address to be added to the whitelist for the API key
        |||,
    } },
    withIpAddresses(value):: self { resource+: {
    ...
    '#withOrganizationId':: { 'function': {
      help:
        |||
          ID for the organization to which the target API Key belongs
        |||,
    } },
    withOrganizationId(value):: self { resource+: {
