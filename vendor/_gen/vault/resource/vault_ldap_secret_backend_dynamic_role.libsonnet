{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_ldap_secret_backend_dynamic_role+: { [terraformName]+: { [name]: value } },
    } },
    '#withCreationLdif':: { 'function': {
      help:
        |||
          A templatized LDIF string used to create a user account. May contain multiple entries.
        |||,
    } },
    withCreationLdif(value):: self { resource+: {
    ...
    withDeletionLdif(value):: self { resource+: {
    ...
    withRollbackLdif(value):: self { resource+: {
