{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_pki_secret_backend_root_sign_intermediate+: { [terraformName]+: { [name]: value } },
    } },
    '#withAltNames':: { 'function': {
      help:
        |||
          List of alternative names.
        |||,
    } },
    withAltNames(value):: self { resource+: {
    ...
    '#withCommonName':: { 'function': {
      help:
        |||
          CN of intermediate to create.
        |||,
    } },
    withCommonName(value):: self { resource+: {
    ...
    withFormat(value):: self { resource+: {
    ...
    withIpSans(value):: self { resource+: {
    ...
    '#withMaxPathLength':: { 'function': {
      help:
        |||
          The maximum path length to encode in the generated certificate.
        |||,
    } },
    withMaxPathLength(value):: self { resource+: {
    ...
    '#withOtherSans':: { 'function': {
      help:
        |||
          List of other SANs.
        |||,
    } },
    withOtherSans(value):: self { resource+: {
    ...
    withRevoke(value):: self { resource+: {
    ...
    '#withUriSans':: { 'function': {
      help:
        |||
          List of alternative URIs.
        |||,
    } },
    withUriSans(value):: self { resource+: {
      vault_pki_secret_backend_root_sign_intermediate+: { [terraformName]+: { uri_sans: value } },
    } },
    '#withUseCsrValues':: { 'function': {
      help:
        |||
          Preserve CSR values.
        |||,
    } },
    withUseCsrValues(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#excluded_email_addresses':: { 'function': {
        help:
          |||
            List of email addresses for which certificates are not allowed to be issued.
          |||,
      ...
      '#permitted_dns_domains':: { 'function': {
        help:
          |||
            List of domains for which certificates are allowed to be issued.
          |||,
      ...
      '#permitted_email_addresses':: { 'function': {
        help:
          |||
            List of email addresses for which certificates are allowed to be issued.
          |||,
      ...
      '#permitted_uri_domains':: { 'function': {
        help:
          |||
            List of URI domains for which certificates are allowed to be issued.
          |||,
