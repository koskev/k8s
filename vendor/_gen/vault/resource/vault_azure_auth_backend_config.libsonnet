{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_azure_auth_backend_config+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withClientSecretWo(value):: self { resource+: {
      vault_azure_auth_backend_config+: { [terraformName]+: { client_secret_wo: value } },
    } },
    '#withClientSecretWoVersion':: { 'function': {
      help:
        |||
    ...
    withClientSecretWoVersion(value):: self { resource+: {
    ...
    withEnvironment(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#client_secret_wo_version':: { 'function': {
        help:
          |||
            Version counter for the write-only client secret. Increment this value to trigger rotation of the client secret. Required when using 'client_secret_wo'.
          |||,
