{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_generic_endpoint+: { [terraformName]+: { [name]: value } },
    } },
    ...
    '#withDisableDelete':: { 'function': {
      help:
        |||
          Don't attempt to delete the path from Vault if true
        |||,
    } },
    withDisableDelete(value):: self { resource+: {
    ...
    '#withIgnoreAbsentFields':: { 'function': {
      help:
        |||
          When reading, disregard fields not present in data_json
        |||,
    } },
    withIgnoreAbsentFields(value):: self { resource+: {
    ...
    '#withWriteFields':: { 'function': {
      help:
        |||
          Top-level fields returned by write to persist in state
        |||,
    } },
    withWriteFields(value):: self { resource+: {
