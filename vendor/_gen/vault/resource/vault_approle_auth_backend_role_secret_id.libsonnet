{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_approle_auth_backend_role_secret_id+: { [terraformName]+: { [name]: value } },
    } },
    ...
    '#withWithWrappedAccessor':: { 'function': {
      help:
        |||
    ...
    withWithWrappedAccessor(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#with_wrapped_accessor':: { 'function': {
        help:
          |||
            Use the wrapped secret-id accessor as the id of this resource. If false, a fresh secret-id will be regenerated whenever the wrapping token is expired or invalidated through unwrapping.
          |||,
