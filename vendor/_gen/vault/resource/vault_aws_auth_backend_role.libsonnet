{
  ...
  functions(terraformName):: {
    ...
    '#bound_account_ids':: { 'function': { help: |||
    ...
    '#bound_ec2_instance_ids':: { 'function': { help: |||
    ...
    '#bound_iam_instance_profile_arns':: { 'function': { help: |||
    ...
    '#bound_iam_principal_arns':: { 'function': { help: |||
    ...
    '#bound_iam_role_arns':: { 'function': { help: |||
    ...
    '#bound_subnet_ids':: { 'function': { help: |||
    ...
    '#inferred_aws_region':: { 'function': { help: |||
    ...
    '#inferred_entity_type':: { 'function': { help: |||
    ...
    '#resolve_aws_unique_ids':: { 'function': { help: |||
