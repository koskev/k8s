{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_approle_auth_backend_login+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withRoleId(value):: self { resource+: {
