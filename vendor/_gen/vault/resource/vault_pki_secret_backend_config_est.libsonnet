{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_pki_secret_backend_config_est+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withDefaultMount(value):: self { resource+: {
    ...
    '#withLabelToPathPolicy':: { 'function': {
      help:
        |||
    ...
    withLabelToPathPolicy(value):: self { resource+: {
