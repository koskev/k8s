{
  ...
  '#new':: { 'function': {
    help:
      |||
        Manages Raft Snapshot Agent Configuration.
      |||,
  } },
  ...
  functions(terraformName):: {
    ...
    '#withPathPrefix':: { 'function': {
      help:
        |||
          The directory or bucket prefix to use.
        |||,
    } },
    withPathPrefix(value):: self { resource+: {
    ...
    withRetain(value):: self { resource+: {
      vault_raft_snapshot_agent_config+: { [terraformName]+: { retain: value } },
    } },
    '#withSecretsWoVersion':: { 'function': {
      help:
        |||
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#aws_s3_force_path_style':: { 'function': {
        help:
          |||
            Use the endpoint/bucket URL style instead of bucket.endpoint.
          |||,
      ...
      '#aws_s3_server_side_encryption':: { 'function': {
        help:
          |||
            Use AES256 to encrypt bucket contents.
          |||,
      ...
      '#aws_secret_access_key_wo':: { 'function': {
        help:
          |||
            AWS secret access key. Write-only: never stored in state. If secrets_wo_version is not set, changes are automatically detected via a hash stored in private state.
          |||,
      ...
      '#azure_blob_environment':: { 'function': {
        help:
          |||
            Azure blob environment.
          |||,
      ...
      '#google_service_account_key':: { 'function': {
        help:
          |||
            Google service account key in JSON format.
          |||,
