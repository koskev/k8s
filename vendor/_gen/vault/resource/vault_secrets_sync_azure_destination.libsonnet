{
  ...
  functions(terraformName):: {
    ...
    '#withClientSecret':: { 'function': {
      help:
        |||
          Client Secret of an Azure app registration.
        |||,
    } },
    withClientSecret(value):: self { resource+: {
    ...
    '#withKeyVaultUri':: { 'function': {
      help:
        |||
          URI of an existing Azure Key Vault instance.
        |||,
    } },
    withKeyVaultUri(value):: self { resource+: {
    ...
    withTenantId(value):: self { resource+: {
