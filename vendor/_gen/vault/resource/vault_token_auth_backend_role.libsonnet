{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_token_auth_backend_role+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withOrphan(value):: self { resource+: {
      vault_token_auth_backend_role+: { [terraformName]+: { orphan: value } },
    } },
    '#withPathSuffix':: { 'function': {
      help:
        |||
          Tokens created against this role will have the given suffix as part of their path in addition to the role name.
        |||,
    } },
    withPathSuffix(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#allowed_entity_aliases':: { 'function': {
        help:
          |||
            Set of allowed entity aliases for this role.
          |||,
      ...
      '#allowed_policies_glob':: { 'function': {
        help:
          |||
            Set of allowed policies with glob match for given role.
          |||,
      ...
      '#disallowed_policies_glob':: { 'function': {
        help:
          |||
            Set of disallowed policies with glob match for given role.
          |||,
