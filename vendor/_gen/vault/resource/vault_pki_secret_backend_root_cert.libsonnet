{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_pki_secret_backend_root_cert+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withKeyRef(value):: self { resource+: {
    ...
    '#withPrivateKeyFormat':: { 'function': {
      help:
        |||
          The private key format.
        |||,
    } },
    withPrivateKeyFormat(value):: self { resource+: {
