{
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#bound_attributes_type':: { 'function': {
        help:
          |||
            The type of matching assertion to perform on bound_attributes.
          |||,
