{
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#jwt_oidc_compatibility_mode':: { 'function': {
        help:
          |||
            If true, SPIFFE IDs in JWT SVIDs must not exceed 255 bytes, the limit for the sub claim in OIDC.
          |||,
      ...
      '#jwt_signing_algorithm':: { 'function': {
        help:
          |||
            Signing algorithm to use for JWTs.
          |||,
