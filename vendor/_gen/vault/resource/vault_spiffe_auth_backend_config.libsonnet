{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_spiffe_auth_backend_config+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withAudience(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#endpoint_root_ca_truststore_pem':: { 'function': {
        help:
          |||
            PEM-encoded CA certificate(s) to validate the server reached by 'endpoint_url', if set this will override the default TLS trust store
          |||,
