{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_aws_auth_backend_cert+: { [terraformName]+: { [name]: value } },
    } },
    '#withAwsPublicCert':: { 'function': {
      help:
        |||
          Base64 encoded AWS Public key required to verify PKCS7 signature of the EC2 instance metadata.
        |||,
    } },
    withAwsPublicCert(value):: self { resource+: {
    ...
    '#withCertName':: { 'function': {
      help:
        |||
          Name of the certificate to configure.
        |||,
    } },
    withCertName(value):: self { resource+: {
