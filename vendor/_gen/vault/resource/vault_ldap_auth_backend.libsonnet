{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_ldap_auth_backend+: { [terraformName]+: { [name]: value } },
    } },
    ...
    '#withEnableSamaccountnameLogin':: { 'function': {
      help:
        |||
          Enables login using the sAMAccountName attribute.
        |||,
    } },
    withEnableSamaccountnameLogin(value):: self { resource+: {
    ...
    withMaxPageSize(value):: self { resource+: {
    ...
    withUserfilter(value):: self { resource+: {
      vault_ldap_auth_backend+: { [terraformName]+: { userfilter: value } },
    } },
    '#withUsernameAsAlias':: { 'function': {
      help:
        |||
          Force the auth method to use the username passed by the user as the alias name.
        |||,
    } },
    withUsernameAsAlias(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#enable_samaccountname_login':: { 'function': {
        help:
          |||
            Enables login using the sAMAccountName attribute.
          |||,
