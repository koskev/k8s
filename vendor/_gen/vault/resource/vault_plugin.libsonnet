{
  ...
  functions(terraformName):: {
    ...
    withCommand(value):: self { resource+: {
    ...
    withOciImage(value):: self { resource+: {
    ...
    withRuntime(value):: self { resource+: {
    ...
    withSha256(value):: self { resource+: {
    ...
    withVersion(value):: self { resource+: {
