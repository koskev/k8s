{
  ...
  functions(terraformName):: {
    ...
    withVerboseLogging(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#validate_assertion_signature':: { 'function': {
        help:
          |||
            Whether to validate the assertion signature.
          |||,
      ...
      '#validate_response_signature':: { 'function': {
        help:
          |||
            Whether to validate the response signature.
          |||,
