{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_aws_auth_backend_sts_role+: { [terraformName]+: { [name]: value } },
    } },
    '#withAccountId':: { 'function': {
      help:
        |||
          AWS account ID to be associated with STS role.
        |||,
    } },
    withAccountId(value):: self { resource+: {
