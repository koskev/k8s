{
  ...
  new(terraformName, auth_type, name):: self.functions(terraformName) + {
    _type:: 'tf',
  ...
  functions(terraformName):: {
    ...
    withChallenge(value):: self { resource+: {
  ...
  ref(terraformName):: {
    local refSelf = self,
    plain(suffix=''):: '${ vault_scep_auth_backend_role.%s%s }' % [terraformName, suffix],
    fields:: {
      ...
      challenge(suffix=''):: refSelf.plain('.challenge%s' % suffix),
