{
  ...
  functions(terraformName):: {
    ...
    '#withRotationStatements':: { 'function': {
      help:
        |||
          Database statements to execute to rotate the password for the configured database user.
        |||,
    } },
    withRotationStatements(value):: self { resource+: {
    ...
    '#withSelfManagedPassword':: { 'function': {
      help:
        |||
    ...
    withSelfManagedPassword(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#self_managed_password':: { 'function': {
        help:
          |||
            The password corresponding to the username in the database. Required when using the Rootless Password Rotation workflow for static roles. Deprecated in favor of password_wo field introduced in Vault 1.19.
          |||,
