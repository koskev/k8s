{
  ...
  functions(terraformName):: {
    ...
    '#withGlobalKmsKey':: { 'function': {
      help:
        |||
          Global KMS key for encryption.
        |||,
    } },
    withGlobalKmsKey(value):: self { resource+: {
    ...
    '#withLocationalKmsKeys':: { 'function': {
      help:
        |||
          Locational KMS keys for encryption.
        |||,
    } },
    withLocationalKmsKeys(value):: self { resource+: {
    ...
    '#withReplicationLocations':: { 'function': {
      help:
        |||
          Replication locations for secrets.
        |||,
    } },
    withReplicationLocations(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#replication_locations':: { 'function': {
        help:
          |||
            Replication locations for secrets.
          |||,
