{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_azure_secret_backend_static_role+: { [terraformName]+: { [name]: value } },
    } },
