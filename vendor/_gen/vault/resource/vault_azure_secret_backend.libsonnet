{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_azure_secret_backend+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withSubscriptionId(value):: self { resource+: {
