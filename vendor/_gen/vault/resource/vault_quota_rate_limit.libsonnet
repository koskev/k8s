{
  ...
  functions(terraformName):: {
    ...
    withBlockInterval(value):: self { resource+: {
      vault_quota_rate_limit+: { [terraformName]+: { block_interval: value } },
    } },
    '#withGroupBy':: { 'function': {
      help:
        |||
    ...
    withGroupBy(value):: self { resource+: {
    ...
    withInterval(value):: self { resource+: {
    ...
    withSecondaryRate(value):: self { resource+: {
