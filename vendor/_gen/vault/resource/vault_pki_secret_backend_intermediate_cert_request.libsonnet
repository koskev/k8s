{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_pki_secret_backend_intermediate_cert_request+: { [terraformName]+: { [name]: value } },
    } },
    '#withAddBasicConstraints':: { 'function': {
      help:
        |||
    ...
    withAddBasicConstraints(value):: self { resource+: {
    ...
    '#withSerialNumber':: { 'function': {
      help:
        |||
          The requested Subject's named serial number.
        |||,
    } },
    withSerialNumber(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      '#add_basic_constraints':: { 'function': {
        help:
          |||
            Set 'CA: true' in a Basic Constraints extension. Only needed as
            a workaround in some compatibility scenarios with Active Directory Certificate Services.
