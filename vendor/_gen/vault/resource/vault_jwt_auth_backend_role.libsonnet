{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_jwt_auth_backend_role+: { [terraformName]+: { [name]: value } },
    } },
    ...
    '#withAllowedRedirectUris':: { 'function': {
      help:
        |||
          The list of allowed values for redirect_uri during OIDC logins.
        |||,
    } },
    withAllowedRedirectUris(value):: self { resource+: {
    ...
    withClockSkewLeeway(value):: self { resource+: {
      vault_jwt_auth_backend_role+: { [terraformName]+: { clock_skew_leeway: value } },
    } },
    '#withDisableBoundClaimsParsing':: { 'function': {
      help:
        |||
          Disable bound claim value parsing. Useful when values contain commas.
        |||,
    } },
    withDisableBoundClaimsParsing(value):: self { resource+: {
      vault_jwt_auth_backend_role+: { [terraformName]+: { disable_bound_claims_parsing: value } },
    } },
    '#withExpirationLeeway':: { 'function': {
      help:
        |||
    ...
    withGroupsClaim(value):: self { resource+: {
    ...
    withOidcScopes(value):: self { resource+: {
    ...
    '#withRoleType':: { 'function': {
      help:
        |||
          Type of role, either "oidc" (default) or "jwt"
        |||,
    } },
    withRoleType(value):: self { resource+: {
    ...
    withUserClaim(value):: self { resource+: {
      vault_jwt_auth_backend_role+: { [terraformName]+: { user_claim: value } },
    } },
    '#withUserClaimJsonPointer':: { 'function': {
      help:
        |||
    ...
    withUserClaimJsonPointer(value):: self { resource+: {
      vault_jwt_auth_backend_role+: { [terraformName]+: { user_claim_json_pointer: value } },
    } },
    '#withVerboseOidcLogging':: { 'function': {
      help:
        |||
    ...
    withVerboseOidcLogging(value):: self { resource+: {
  ...
  ref(terraformName):: {
    local refSelf = self,
    plain(suffix=''):: '${ vault_jwt_auth_backend_role.%s%s }' % [terraformName, suffix],
    fields:: {
      ...
      '#allowed_redirect_uris':: { 'function': {
        help:
          |||
            The list of allowed values for redirect_uri during OIDC logins.
          |||,
      ...
      '#disable_bound_claims_parsing':: { 'function': {
        help:
          |||
            Disable bound claim value parsing. Useful when values contain commas.
          |||,
      ...
      '#user_claim_json_pointer':: { 'function': {
        help:
          |||
            Specifies if the user_claim value uses JSON pointer syntax for referencing claims. By default, the user_claim value will not use JSON pointer.
          |||,
