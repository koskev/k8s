{
  ...
  functions(terraformName):: {
    ...
    '#withMinEnabledVersion':: { 'function': {
      help:
        |||
    ...
    withMinEnabledVersion(value):: self { resource+: {
