{
  ...
  functions(terraformName):: {
    withForEach(value):: self { resource+: {
      vault_identity_group_alias+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { resource+: {
      vault_identity_group_alias+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { resource+: {
      vault_identity_group_alias+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { resource+: {
      vault_identity_group_alias+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { resource+: {
      vault_identity_group_alias+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { resource+: {
      vault_identity_group_alias+: { [terraformName]+: { providers: value } },
    } },
    addCustomData(name, value):: self { resource+: {
      vault_identity_group_alias+: { [terraformName]+: { [name]: value } },
    } },
    '#withCanonicalId':: { 'function': {
      help:
        |||
          ID of the group to which this is an alias.
        |||,
    } },
    withCanonicalId(value):: self { resource+: {
