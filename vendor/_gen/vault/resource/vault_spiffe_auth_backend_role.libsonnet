{
  ...
  functions(terraformName):: {
    withForEach(value):: self { resource+: {
      vault_spiffe_auth_backend_role+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { resource+: {
      vault_spiffe_auth_backend_role+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { resource+: {
      vault_spiffe_auth_backend_role+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { resource+: {
      vault_spiffe_auth_backend_role+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { resource+: {
      vault_spiffe_auth_backend_role+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { resource+: {
      vault_spiffe_auth_backend_role+: { [terraformName]+: { providers: value } },
    } },
    ...
    '#withWorkloadIdPatterns':: { 'function': {
      help:
        |||
    ...
    withWorkloadIdPatterns(value):: self { resource+: {
