{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_secrets_sync_config+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withDisabled(value):: self { resource+: {
    ...
    '#withQueueCapacity':: { 'function': {
      help:
        |||
          Maximum number of pending sync operations allowed on the queue.
        |||,
    } },
    withQueueCapacity(value):: self { resource+: {
