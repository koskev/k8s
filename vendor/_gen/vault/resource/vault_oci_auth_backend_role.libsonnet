{
  ...
  functions(terraformName):: {
    withForEach(value):: self { resource+: {
      vault_oci_auth_backend_role+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { resource+: {
      vault_oci_auth_backend_role+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { resource+: {
      vault_oci_auth_backend_role+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { resource+: {
      vault_oci_auth_backend_role+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { resource+: {
      vault_oci_auth_backend_role+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { resource+: {
      vault_oci_auth_backend_role+: { [terraformName]+: { providers: value } },
    } },
  ...
  ref(terraformName):: {
    local refSelf = self,
    plain(suffix=''):: '${ vault_oci_auth_backend_role.%s%s }' % [terraformName, suffix],
    fields:: {
      ...
      ocid_list(suffix=''):: refSelf.plain('.ocid_list%s' % suffix),
