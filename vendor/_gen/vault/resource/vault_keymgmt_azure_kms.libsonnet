{
  ...
  functions(terraformName):: {
    withForEach(value):: self {
      resource+: {
        vault_keymgmt_azure_kms+: { [terraformName]+: { for_each: value } },
      },
    },
    withDependsOn(value):: self {
      resource+: {
        vault_keymgmt_azure_kms+: { [terraformName]+: { depends_on: value } },
      },
    },
    withCount(value):: self {
      resource+: {
        vault_keymgmt_azure_kms+: { [terraformName]+: { count: value } },
      },
    },
    withLifecycle(value):: self {
      resource+: {
        vault_keymgmt_azure_kms+: { [terraformName]+: { lifecycle: value } },
      },
    },
    withProvider(value):: self {
      resource+: {
        vault_keymgmt_azure_kms+: { [terraformName]+: { provider: value } },
      },
    },
    withProviders(value):: self {
      resource+: {
        vault_keymgmt_azure_kms+: { [terraformName]+: { providers: value } },
      },
    },
