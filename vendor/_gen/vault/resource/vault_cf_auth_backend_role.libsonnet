{
  ...
  functions(terraformName):: {
    withForEach(value):: self { resource+: {
      vault_cf_auth_backend_role+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { resource+: {
      vault_cf_auth_backend_role+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { resource+: {
      vault_cf_auth_backend_role+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { resource+: {
      vault_cf_auth_backend_role+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { resource+: {
      vault_cf_auth_backend_role+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { resource+: {
      vault_cf_auth_backend_role+: { [terraformName]+: { providers: value } },
    } },
    ...
    '#withBoundApplicationIds':: { 'function': {
      help:
        |||
    ...
    withBoundApplicationIds(value):: self { resource+: {
      vault_cf_auth_backend_role+: { [terraformName]+: { bound_application_ids: value } },
    } },
    '#withBoundInstanceIds':: { 'function': {
      help:
        |||
    ...
    withBoundInstanceIds(value):: self { resource+: {
      vault_cf_auth_backend_role+: { [terraformName]+: { bound_instance_ids: value } },
    } },
    '#withBoundOrganizationIds':: { 'function': {
      help:
        |||
    ...
    withBoundOrganizationIds(value):: self { resource+: {
      vault_cf_auth_backend_role+: { [terraformName]+: { bound_organization_ids: value } },
    } },
    '#withBoundSpaceIds':: { 'function': {
      help:
        |||
    ...
    withBoundSpaceIds(value):: self { resource+: {
      vault_cf_auth_backend_role+: { [terraformName]+: { bound_space_ids: value } },
    } },
    '#withDisableIpMatching':: { 'function': {
      help:
        |||
    ...
    withDisableIpMatching(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#bound_application_ids':: { 'function': {
        help:
          |||
            An optional set of application IDs an instance must be a member of to qualify for this role. To clear this constraint, omit the field entirely rather than setting it to an empty list.
          |||,
      ...
      '#bound_organization_ids':: { 'function': {
        help:
          |||
            An optional set of organization IDs an instance must be a member of to qualify for this role. To clear this constraint, omit the field entirely rather than setting it to an empty list.
          |||,
