{
  ...
  functions(terraformName):: {
    ...
    '#withScopesSupported':: { 'function': {
      help:
        |||
          The scopes available for requesting on the provider.
        |||,
    } },
    withScopesSupported(value):: self { resource+: {
