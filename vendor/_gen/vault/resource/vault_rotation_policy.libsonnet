{
  ...
  ref(terraformName):: {
    ...
    fields:: {
      '#max_retries_per_cycle':: { 'function': {
        help:
          |||
            Maximum retries per cycle for this rotation policy.
          |||,
