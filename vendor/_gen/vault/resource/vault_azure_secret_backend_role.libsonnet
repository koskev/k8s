{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_azure_secret_backend_role+: { [terraformName]+: { [name]: value } },
    } },
    '#withApplicationObjectId':: { 'function': {
      help:
        |||
          Application Object ID for an existing service principal that will be used instead of creating dynamic service principals.
        |||,
    } },
    withApplicationObjectId(value):: self { resource+: {
    ...
    '#withPermanentlyDelete':: { 'function': {
      help:
        |||
    ...
    withSignInAudience(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      '#application_object_id':: { 'function': {
        help:
          |||
            Application Object ID for an existing service principal that will be used instead of creating dynamic service principals.
          |||,
