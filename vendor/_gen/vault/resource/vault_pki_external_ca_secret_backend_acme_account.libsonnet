{
  ...
  functions(terraformName):: {
    ...
    '#withDirectoryUrl':: { 'function': {
      help:
        |||
          ACME Directory URL.
        |||,
    } },
    withDirectoryUrl(value):: self { resource+: {
    ...
    withEabKey(value):: self { resource+: {
    ...
    '#withTrustedCa':: { 'function': {
      help:
        |||
          Trusted CA certificates for the ACME server.
        |||,
    } },
    withTrustedCa(value):: self { resource+: {
