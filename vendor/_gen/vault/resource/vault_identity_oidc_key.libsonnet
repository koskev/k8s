{
  ...
  functions(terraformName):: {
    withForEach(value):: self { resource+: {
      vault_identity_oidc_key+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { resource+: {
      vault_identity_oidc_key+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { resource+: {
      vault_identity_oidc_key+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { resource+: {
      vault_identity_oidc_key+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { resource+: {
      vault_identity_oidc_key+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { resource+: {
      vault_identity_oidc_key+: { [terraformName]+: { providers: value } },
    } },
