{
  ...
  functions(terraformName):: {
    ...
    withBackupAuthTypes(value):: self { resource+: {
      vault_config_ui_default_auth+: { [terraformName]+: { backup_auth_types: value } },
    } },
    '#withDefaultAuthType':: { 'function': {
      help:
        |||
    ...
    withDefaultAuthType(value):: self { resource+: {
      vault_config_ui_default_auth+: { [terraformName]+: { default_auth_type: value } },
    } },
    '#withDisableInheritance':: { 'function': {
      help:
        |||
    ...
    withDisableInheritance(value):: self { resource+: {
