{
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#assume_role_session_name':: { 'function': {
        help:
          |||
            Session name to use when assuming the role.
          |||,
