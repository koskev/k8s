{
  ...
  functions(terraformName):: {
    ...
    withExplicitMaxTtl(value):: self { resource+: {
    ...
    withMetadata(value):: self { resource+: {
    ...
    withNoParent(value):: self { resource+: {
    ...
    withNumUses(value):: self { resource+: {
    ...
    '#withRenewIncrement':: { 'function': {
      help:
        |||
          The renew increment.
        |||,
    } },
    withRenewIncrement(value):: self { resource+: {
      vault_token+: { [terraformName]+: { renew_increment: value } },
    } },
    '#withRenewMinLease':: { 'function': {
      help:
        |||
          The minimum lease to renew token.
        |||,
    } },
    withRenewMinLease(value):: self { resource+: {
    ...
    withRenewable(value):: self { resource+: {
    ...
    withWrappingTtl(value):: self { resource+: {
