{
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      vault_aws_auth_backend_login+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withIdentity(value):: self { resource+: {
    ...
    withSignature(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#iam_http_request_method':: { 'function': {
        help:
          |||
            The HTTP method used in the signed request.
          |||,
