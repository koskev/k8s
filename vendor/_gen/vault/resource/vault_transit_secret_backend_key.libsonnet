{
  ...
  functions(terraformName):: {
    withForEach(value):: self { resource+: {
      vault_transit_secret_backend_key+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { resource+: {
      vault_transit_secret_backend_key+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { resource+: {
      vault_transit_secret_backend_key+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { resource+: {
      vault_transit_secret_backend_key+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { resource+: {
      vault_transit_secret_backend_key+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { resource+: {
      vault_transit_secret_backend_key+: { [terraformName]+: { providers: value } },
    } },
    addCustomData(name, value):: self { resource+: {
      vault_transit_secret_backend_key+: { [terraformName]+: { [name]: value } },
    } },
    '#withAllowPlaintextBackup':: { 'function': {
      help:
        |||
          If set, enables taking backup of named key in the plaintext format. Once set, this cannot be disabled.
        |||,
    } },
    withAllowPlaintextBackup(value):: self { resource+: {
      vault_transit_secret_backend_key+: { [terraformName]+: { allow_plaintext_backup: value } },
    } },
    '#withAutoRotatePeriod':: { 'function': {
      help:
        |||
    ...
    withAutoRotatePeriod(value):: self { resource+: {
    ...
    withContext(value):: self { resource+: {
      vault_transit_secret_backend_key+: { [terraformName]+: { context: value } },
    } },
    '#withConvergentEncryption':: { 'function': {
      help:
        |||
          Whether or not to support convergent encryption, where the same plaintext creates the same ciphertext. This requires derived to be set to true.
        |||,
    } },
    withConvergentEncryption(value):: self { resource+: {
    ...
    '#withMinDecryptionVersion':: { 'function': {
      help:
        |||
          Minimum key version to use for decryption.
        |||,
    } },
    withMinDecryptionVersion(value):: self { resource+: {
      vault_transit_secret_backend_key+: { [terraformName]+: { min_decryption_version: value } },
    } },
    '#withMinEncryptionVersion':: { 'function': {
      help:
        |||
          Minimum key version to use for encryption
        |||,
    } },
    withMinEncryptionVersion(value):: self { resource+: {
    ...
    withParameterSet(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      '#allow_plaintext_backup':: { 'function': {
        help:
          |||
            If set, enables taking backup of named key in the plaintext format. Once set, this cannot be disabled.
          |||,
      ...
      '#convergent_encryption':: { 'function': {
        help:
          |||
            Whether or not to support convergent encryption, where the same plaintext creates the same ciphertext. This requires derived to be set to true.
          |||,
      ...
      '#min_available_version':: { 'function': {
        help:
          |||
      ...
      '#min_decryption_version':: { 'function': {
        help:
          |||
            Minimum key version to use for decryption.
          |||,
      ...
      '#min_encryption_version':: { 'function': {
        help:
          |||
            Minimum key version to use for encryption
          |||,
