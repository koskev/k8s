{
  ...
  functions(terraformName):: {
    ...
    withDecodeFormats(value):: self { resource+: {
      vault_transform_template+: { [terraformName]+: { decode_formats: value } },
    } },
    '#withEncodeFormat':: { 'function': {
      help:
        |||
    ...
    withEncodeFormat(value):: self { resource+: {
    ...
    withPattern(value):: self { resource+: {
