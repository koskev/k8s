{
  ...
  functions(terraformName):: {
    withForEach(value):: self { resource+: {
      vault_approle_auth_backend_role+: { [terraformName]+: { for_each: value } },
    } },
    withDependsOn(value):: self { resource+: {
      vault_approle_auth_backend_role+: { [terraformName]+: { depends_on: value } },
    } },
    withCount(value):: self { resource+: {
      vault_approle_auth_backend_role+: { [terraformName]+: { count: value } },
    } },
    withLifecycle(value):: self { resource+: {
      vault_approle_auth_backend_role+: { [terraformName]+: { lifecycle: value } },
    } },
    withProvider(value):: self { resource+: {
      vault_approle_auth_backend_role+: { [terraformName]+: { provider: value } },
    } },
    withProviders(value):: self { resource+: {
      vault_approle_auth_backend_role+: { [terraformName]+: { providers: value } },
    } },
    addCustomData(name, value):: self { resource+: {
      vault_approle_auth_backend_role+: { [terraformName]+: { [name]: value } },
    } },
    ...
    withLocalSecretIds(value):: self { resource+: {
  ...
  ref(terraformName):: {
    ...
    fields:: {
      ...
      '#secret_id_bound_cidrs':: { 'function': {
        help:
          |||
            List of CIDR blocks that can log in using the AppRole.
          |||,
