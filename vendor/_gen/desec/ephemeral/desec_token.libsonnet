{
  ...
  functions(terraformName):: {
    ...
    ||| } },
    withMaxUnusedPeriod(value):: self {
      ephemeral+: {
    ...
    ||| } },
    withPermCreateDomain(value):: self {
      ephemeral+: {
    ...
    ||| } },
    withPermDeleteDomain(value):: self {
      ephemeral+: {
    ...
    ||| } },
    withPermManageTokens(value):: self {
      ephemeral+: {
