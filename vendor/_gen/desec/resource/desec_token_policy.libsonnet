{
  ...
  new(terraformName, token_id):: self.functions(terraformName) + {
    ...
    resource+: {
      desec_token_policy+: { [terraformName]+: {
        token_id: token_id,
      } },
    },
  }
  ...
  functions(terraformName):: {
    ...
    addCustomData(name, value):: self { resource+: {
      desec_token_policy+: { [terraformName]+: { [name]: value } },
    } },
    '#withDomain':: { 'function': {
      help:
        |||
    ...
    withSubname(value):: self { resource+: {
    ...
    withTokenId(value):: self { resource+: {
